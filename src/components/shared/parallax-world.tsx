...
export function ParallaxWorld() {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      {/* Slowly drifting geometric road/route lines (theme-aware) */}
      <motion.div
        className="absolute inset-0 will-change-transform"
        style={{ y: globalY }}
      >
        <svg
          className="w-full h-[200vh] opacity-[0.5]"
          viewBox="0 0 1920 2160"
          preserveAspectRatio="xMidYMin slice"
          fill="none"
        >
          {/* Horizontal route lines - uses pattern-line for theme-awareness */}
          <line x1="0" y1="200" x2="1920" y2="220" stroke="var(--pattern-line)" strokeWidth="1" />
          <line x1="0" y1="400" x2="1920" y2="380" stroke="var(--pattern-line)" strokeWidth="0.5" />
          <line x1="0" y1="600" x2="1920" y2="620" stroke="var(--pattern-line)" strokeWidth="1" />
          <line x1="0" y1="800" x2="1920" y2="790" stroke="var(--pattern-line)" strokeWidth="0.5" />
          <line x1="0" y1="1000" x2="1920" y2="1010" stroke="var(--pattern-line)" strokeWidth="1" />
          <line x1="0" y1="1200" x2="1920" y2="1180" stroke="var(--pattern-line)" strokeWidth="0.5" />
          <line x1="0" y1="1400" x2="1920" y2="1420" stroke="var(--pattern-line)" strokeWidth="1" />
          <line x1="0" y1="1600" x2="1920" y2="1590" stroke="var(--pattern-line)" strokeWidth="0.5" />
          <line x1="0" y1="1800" x2="1920" y2="1810" stroke="var(--pattern-line)" strokeWidth="1" />
          <line x1="0" y1="2000" x2="1920" y2="1990" stroke="var(--pattern-line)" strokeWidth="0.5" />

          {/* Subtle diagonal connectors */}
          <path d="M0,300 Q480,350 960,300 T1920,320" stroke="var(--pattern-line)" strokeWidth="0.5" opacity="0.5" />
          <path d="M0,900 Q480,850 960,900 T1920,880" stroke="var(--pattern-line)" strokeWidth="0.5" opacity="0.5" />
          <path d="M0,1500 Q480,1550 960,1500 T1920,1520" stroke="var(--pattern-line)" strokeWidth="0.5" opacity="0.5" />
        </svg>
      </motion.div>

      {/* Radial gradient light sources that shift with scroll (theme-aware) */}
      <motion.div
