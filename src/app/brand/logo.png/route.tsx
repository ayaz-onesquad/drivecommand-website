...
// Generate PNG logo for schema.org structured data
// Google prefers PNG/JPG over SVG for Organization logo
    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          {/* Glyph */}
          <svg width="120" height="120" viewBox="0 0 500 500" fill="none">
            <path
