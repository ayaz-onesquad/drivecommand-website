...
export const alt = 'Contact DriveCommand - Talk to Our Team'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Get in touch with our team. We respond within one business day.
        </div>
        ...
        >
          ...
          >
            <span style={{ fontSize: '20px', color: '#FFFFFF', fontFamily: 'system-ui' }}>✉️ team@drivecommand.io</span>
          </div>
          <div
            style={{
              display: 'flex',
          ...
          >
            <span style={{ fontSize: '20px', color: '#FFFFFF', fontFamily: 'system-ui' }}>📞 (219) 487-0146</span>
          </div>
          <div
            style={{
              display: 'flex',
          ...
          >
            <span style={{ fontSize: '20px', color: '#FFFFFF', fontFamily: 'system-ui' }}>📍 Munster, IN</span>
          </div>
        </div>
      </div>
    ),
