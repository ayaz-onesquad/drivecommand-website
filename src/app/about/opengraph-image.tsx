...
export const alt = 'About DriveCommand - Fleet Management Built by People Who Get It'
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Former fleet owners and dispatchers building the tools they wish they had.
        </div>
        ...
        >
          ...
          >
            <span style={{ fontSize: '20px', color: '#FFFFFF', fontFamily: 'system-ui' }}>🚛 20+ Years Fleet Experience</span>
          </div>
          <div
            style={{
              display: 'flex',
